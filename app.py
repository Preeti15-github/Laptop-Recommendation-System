...
def recommend_laptops(laptop_name, top_n=5):
    ...
    df['Model_lower'] = df['Company'].str.lower()  # Use 'Company' as identifier
    ...
    recommended_laptops = df.iloc[[i[0] for i in sorted_scores]][['Company', 'Processor', 'RAM', 'Price', 'MRP', 'Review', 'ImgURL']]
        ...
        try:
            ...
            if laptop_name and laptop_name.strip():
                ...
                if not recommendations:
                    error_message = "No similar laptops found. Please enter a valid laptop name."
            else:
